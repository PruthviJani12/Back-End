...
<header>
    ...
    <table>
        ...
        <tr>
            ...
            <th width="250px">Email<br>
                <hr>
            </th>
            <th width="250px">Phone<br>
                <hr>
            </th>
            <th width="250px">Occupation<br>
                <hr>
            </th>
        ...
        /* 	function fetches a result row as an associative array.
			...
			*/
        $sql = mysqli_query($link, "SELECT Parent_id,Fname,Lname,Addres,Email,Phone_No,Occupation  FROM parents");
