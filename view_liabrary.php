...
<header>
    ...
    <table>
        ...
        <tr>
            <th width="150px">Issue ID<br>
                <hr>
            </th>
            <th width="250px">School ID<br>
                <hr>
            </th>
            <th width="250px">Book Name<br>
                <hr>
            </th>
            

            <th width="250px">Issue Date<br>
                <hr>
            </th>
            <th width="150px">Return Date<br>
                <hr>
            </th>
        ...
        /* 	function fetches a result row as an associative array.
			...
			*/
        $sql = mysqli_query($link, "SELECT Issue_id,Schools_id,Book_Name,Issue_Date,Return_Date  FROM liabrary_books");
        while ($row = $sql->fetch_assoc()) {
            echo "
			<tr>
				<th>{$row['Issue_id']}</th>
                <th>{$row['Schools_id']}</th>
                <th>{$row['Book_Name']}</th>
