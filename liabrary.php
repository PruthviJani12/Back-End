...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO liabrary_books (Schools_id,Book_Name,Issue_Date,Return_Date)
         VALUES ('$child','$Book','$id','$rd')";

        if (mysqli_query($link, $sql)) {
            echo "<b>The Book has been Issued Successfully</b> ";
        } else {
        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 col-xl-12 col-xxl-12">
                    ...
                    <form target="_blank" action="liabrary.php" method="post">
                        <p Id="form_title">liabrary Book Issue</p>
                        ...
                        <br>
                            ...
                            <label for="Book">Book's Name</label><br>
                            <input type="text" id="Book" name="Book" placeholder="Book's Name" required><br>



                            <label for="issue_date">Issue Date:</label><br>
                            <input type="date" id="issue_date" name="id" required><br>
