...
<header>
    ...
    <table>
        ...
        <tr>
            <th width="150px">Sports_Registration_Id<br>
                <hr>
            </th>
            <th width="250px">Student_id<br>
                <hr>
            </th>
            <th width="250px">Name_of_Sport<br>
                <hr>
            </th>
            <th width="150px">Height(cm)<br>
                <hr>
            </th>
            <th width="250px">Weight(Kg)<br>
                <hr>
            </th>
        ...
        /* 	function fetches a result row as an associative array.
			...
			*/
        $sql = mysqli_query($link, "SELECT Sports_Registration_Id,Student_id,Name_of_Sport,Height,Weight  FROM sports_team_registration");
        while ($row = $sql->fetch_assoc()) {
            echo "
			<tr>
				<th>{$row['Sports_Registration_Id']}</th>
                <th>{$row['Student_id']}</th>
				<th>{$row['Name_of_Sport']}</th>
                <th>{$row['Height']}</th>
                <th>{$row['Weight']}</th>
